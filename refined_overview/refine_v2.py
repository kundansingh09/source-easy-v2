...
CACHE_DIR           = "cache_refine"

# Per-field content budgets (characters). Keeping these separate rather than
# one global cap because about and website_scrape have very different
# signal-to-noise ratios: about is already SEMICON-filtered multi-show content
# (high density, worth more tokens); website_scrape is a homepage which may be
# a sprawling corporate nav or a one-liner (low density, cap harder).
ABOUT_MAX_CHARS        = 3000
WEBSITE_MAX_CHARS      = 2500
